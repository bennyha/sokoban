...
public class SokobanControls extends Observable implements Initializable,View {
	private Level lvl;
	...
	@FXML
	private SokobanDisplayer displayer;
	...
	@Override
	public void display(Level l) throws Exception {
		this.lvl=l;
